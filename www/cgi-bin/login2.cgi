	...
	<td class="light">
		...
		<script type="text/javascript">
			function playVoice(lang) {
				var wavURL    = "http://list.net.nthu.edu.tw/slist/cgi-bin/validate_tts.cgi?lang=" + lang;
				var embedCode = '<embed src=' + wavURL + ' hidden="true" autoplay="true" loop="true" width="1" height="1"></embed>' +
					'<noembed><a href="' + wavURL + '">語音</a></noembed>';
				document.getElementById("playAudio").innerHTML = "";
				document.getElementById("playAudio").innerHTML = embedCode;
			}
			document.write("<a href=\\"javascript:playVoice();\\">英語</a>\\n" +
					"<a href=\\"javascript:playVoice('zh');\\">華語</a>\\n" +
					"<a href=\\"javascript:playVoice('tw');\\">台語</a>\\n" +
					"<div id=\\"playAudio\\"></div>\\n");
		</script>
		<noscript>
			<a href="http://list.net.nthu.edu.tw/slist/cgi-bin/validate_tts.cgi">英語</a>
			<a href="http://list.net.nthu.edu.tw/slist/cgi-bin/validate_tts.cgi?lang=zh">華語</a>
			<a href="http://list.net.nthu.edu.tw/slist/cgi-bin/validate_tts.cgi?lang=tw">台語</a>
		</noscript>
	</td>
</tr>
<tr>
