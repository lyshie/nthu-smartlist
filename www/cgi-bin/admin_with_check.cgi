...
sub getAdminContent
{
    ...
    my $invalid_email = scalar(check_email($listname)) || 0;
    ...
    $tips .= "\n目前訂閱戶有 <span class=\"alert\">$a</span> 個 (<span class=\"alert\"><a href=\"editdist.cgi?sid=$sid\">疑似名稱異常有 $invalid_email 個</a></span>)，自行取消訂閱的有 $f 個。";
